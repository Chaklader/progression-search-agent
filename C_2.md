...
4. **When P is False and Q is False**: The implication is True
    ...
    - Example: "If I am the King of France, then the moon is made of cheese." Both parts are false, but the implication
      is still true in formal logic because the
      $\text{second part only needs to be true (moon is made of cheese) when the
      first part is true as well}$. As
      the first part is not true, the promise is not broken and the second part becomes irrelevant. The implication
      doen’t tell if I’m not the King of France, the mooncan’t be made of cheese.
