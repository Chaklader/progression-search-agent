...
The core DPLL algorithm combines backtracking search with two key optimizations: **unit propagation** and **pure
literal** **elimination**. These optimizations dramatically reduce the search space compared to naive backtracking.
